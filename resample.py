...
if __name__ == "__main__":
    ...
    for date in tqdm(dateList[:]):
        ...
        for code in tqdm(code_list):
            ...
            try: 
                assert df.iloc[0]["eventTime"] > 93000000.0
            except:
                print(df.iloc[0]["eventTime"])
                print(code)

            # assert df.iloc[-1]["eventTime"] < 145900000.0

            # resampled df ever 5 seconds
            # df_resampled = df_resample(df, sampling_interval=5000.0, on='eventTime')
